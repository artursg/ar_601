...
left_flag=-1;
%right
left=[-offset 0 0;-offset 0 0;-offset+l_y 0 0];
right=[offset 0 0;offset+l_y 0 0;offset+l_y 0 0];
...
%dlmwrite('right.traj',result_matrix);
dlmwrite('~/catkin_ws/src/ar_601/ar601_trajectories/trajectories/step_right.traj',result_matrix);
